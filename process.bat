...
REM process train\13STS.input.FNWN.txt train\13STS.gs.FNWN.txt test\13STS.input.FNWN.txt test\13STS.gs.FNWN.txt output.txt

REM process train\13STS.input.headlines.txt train\13STS.gs.headlines.txt test\13STS.input.headlines.txt test\13STS.gs.headlines.txt output.txt

REM process train\13STS.input.OnWN.txt train\13STS.gs.OnWN.txt test\13STS.input.OnWN.txt test\13STS.gs.OnWN.txt output.txt

REM process train\joint.input.txt train\joint.gs.txt test\joint.input.txt test\joint.gs.txt output.txt
